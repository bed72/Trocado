...
- [ ] `flutter test test/src/infrastructure/clients/http/interceptors/authentication_interceptor_test.dart` — todos os 6 testes verdes (5 existentes + 1 novo)
