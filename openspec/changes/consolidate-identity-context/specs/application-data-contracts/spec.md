...
- **AND** os UseCases continuam retornando `BudgetEntity` em vez de Outputs redundantes

#### Scenario: Retornos atuais de Budget
- **WHEN** um UseCase ou Repository de Budget retorna uma Entity, lista homogênea, identificador, contagem ou booleano suficiente
