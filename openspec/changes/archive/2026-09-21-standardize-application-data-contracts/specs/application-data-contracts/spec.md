...
Authentication e User MUST ser revisados durante a adoção desta convenção. A revisão MUST migrar os contratos que atendam aos critérios de Input ou Output e MUST preservar parâmetros explícitos e retornos naturais onde uma classe adicional não melhorar o contrato.
