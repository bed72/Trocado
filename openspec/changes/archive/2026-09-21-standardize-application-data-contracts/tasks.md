...
- [x] 5.1 Executar os testes focados de Authentication e arquitetura, corrigindo incompatibilidades de tipos e named arguments introduzidas pelas novas assinaturas.
- [x] 5.2 Executar a suíte completa para confirmar que User e os demais fluxos continuam sem regressões.
