# expense-row-level-security Specification

## Purpose
Define o isolamento de despesas por política PostgreSQL RLS e o escopo transacional do principal autenticado, com permissões distintas para runtime e manutenção.
## Requirements
