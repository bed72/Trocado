# authenticated-api-rate-limiting Specification

## Purpose
Definir a cota compartilhada por User para as rotas autenticadas da API, preservando a autenticação, a revogação de tokens e o contrato JSON:API quando o limite for excedido.
## Requirements
