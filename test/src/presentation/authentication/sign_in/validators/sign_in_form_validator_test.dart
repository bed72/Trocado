...
void main() {
  ...
  group('SignInFormValidator', () {
    ...
    test(
      'sets only emailFailure when email is invalid and password is valid',
      () {
    ...
    test(
      'sets only passwordFailure when password is invalid and email is valid',
      () {
    ...
    test(
      'returns isValid true and clears failures when both fields are valid',
      () {
        const input = SignInState(
