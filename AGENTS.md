...
- Exemplos: `ExpenseEntity`, `CreateExpenseInput`, `SignInOutput`, `ExpenseRepository`, `TransactionPort`, `DatabaseTransactionAdapter`, `EloquentExpenseRepository`, `ExpenseModel`, `CreateExpenseUseCase` e `ExpenseResponse`.
