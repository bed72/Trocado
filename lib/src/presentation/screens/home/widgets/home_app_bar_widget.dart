...
import 'package:trocado/src/presentation/screens/home/widgets/home_avatar_widget.dart';
import 'package:trocado/src/presentation/screens/home/widgets/home_greeting_widget.dart';
    ...
    return Skeletonizer(
      ...
      child: AppBar(
        ...
        title: Row(
          spacing: 12.0,
          children: [
            HomeAvatarWidget(avatar: user?.avatar),
