...
import 'package:trocado/src/presentation/screens/home/preview/mocks/insight_mock.dart';
...
Widget previewSuccessSingle() => _carousel(
  AsyncData(insightsBundleMock(const [dangerBudgetInsightMock])),
);
...
Widget previewSuccessInfo() => _carousel(
  AsyncData(insightsBundleMock(const [topCategoryInsightMock])),
);
