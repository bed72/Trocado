...
@ProviderFor(remoteInsightsDataSource)
final remoteInsightsDataSourceProvider = RemoteInsightsDataSourceProvider._();

final class RemoteInsightsDataSourceProvider
    extends
        $FunctionalProvider<
          IRemoteInsightsDataSource,
          IRemoteInsightsDataSource,
          IRemoteInsightsDataSource
        >
    with $Provider<IRemoteInsightsDataSource> {
  RemoteInsightsDataSourceProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'remoteInsightsDataSourceProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$remoteInsightsDataSourceHash();

  @$internal
  @override
  $ProviderElement<IRemoteInsightsDataSource> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  IRemoteInsightsDataSource create(Ref ref) {
    return remoteInsightsDataSource(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(IRemoteInsightsDataSource value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<IRemoteInsightsDataSource>(value),
    );
  }
}

String _$remoteInsightsDataSourceHash() =>
    r'18b3c7c33bd1420d498dbf0da9e4fec2b9430c52';
